...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid bg-white" style="overflow-x: hidden; " id="orderHistory">
        <div class="return p-3 text-dark">
            <a href="<?php echo e(route('cashier-order-history.get')); ?>" class="text-dark"><i class="ph ph-arrow-left me-1"></i></a>
        </div>
...
<?php echo $__env->make('Layout.cashier_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\city_burgers_pos_system\resources\views/Cashier/cashier_order_receipt.blade.php ENDPATH**/ ?>