...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid bg-white" id="orderHistory" style="overflow-x: hidden;">
        <div class="return p-3 text-dark">
            <a href="<?php echo e(route('cashier-order.get')); ?>" class="text-dark"><i class="ph ph-arrow-left me-1"></i></a>
        </div>
        ...
        <div>
            ...
            <div class="filter-categories">
                <div class="row flex-nowrap overflow-auto">
                    ...
                    <a href="<?php echo e(route('cashier-order-history-filter.get', ['filter' => 'this-month'])); ?>"
                        class="filter filter--this-month <?php echo e(request('filter') === 'this-month' ? 'active' : ''); ?>">
                        <i class="ph ph-calendar-blank me-1"></i> This Month
                    </a>
                    <a href="<?php echo e(route('cashier-order-history-filter.get', ['filter' => 'this-year'])); ?>"
...
<?php echo $__env->make('Layout.cashier_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\city_burgers_pos_system\resources\views/Cashier/cashier_order_history.blade.php ENDPATH**/ ?>