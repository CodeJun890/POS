<nav id="cashierNav" class="d-flex justify-content-between align-items-center py-3 px-1 text-white">
    <div class="name d-flex align-items-center">
        ...
        <span class="text-uppercase ms-2">{{ $user->role }}</span>
    </div>


    <div class="d-flex align-items-center gap-2">
        <div>
            Hi, <span class="fw-bold">{{ explode(' ', $user->name)[0] }}</span>
        </div>
    ...
    <div class="offcanvas-body">
        <ul class="nav flex-column">
            <li class="nav-item mb-3">
                <i class="ph-house"></i>
                <a class="nav-link text-white" href="{{ route('cashier-dashboard.get') }}">
                    Dashboard
                </a>
            </li>
            <li class="nav-item mb-3">
                <i class="ph-user-circle"></i>
                <a class="nav-link text-white" href="{{ route('cashier-profile.get') }}">
                    My Profile
                </a>
            </li>
            <li class="nav-item mb-3">
                <i class="ph-shopping-cart"></i>
                <a class="nav-link text-white" href="{{ route('cashier-order.get') }}">
                    Create Order
                </a>
            </li>
            <li class="nav-item mb-3">
                <i class="ph-clock-counter-clockwise"></i>
                <a class="nav-link text-white" href="{{ route('cashier-order-history.get') }}">
                    Order History
                </a>
            </li>
