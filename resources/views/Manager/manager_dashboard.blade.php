...
@section('content')
        ...
        <div class="dashboard-header p-3">
            ...
            <div class="container bg-light rounded-3 p-3 mt-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-uppercase fw-bold text-dark">{{ now()->format('Y') }}</div>
                </div>
                <div class="d-flex justify-content-between align-items-center mt-1">
                    <span class="fs-1">&#8369;{{ number_format($totalSales, 2) }}</span>
            ...
            <div class="container bg-light rounded-3 p-3 mt-3">
                ...
                <div class="d-flex justify-content-between align-items-center mt-1">
                    <span class="fs-1">&#8369;{{ number_format($totalProfit, 2) }}</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const chartData = @json($chartData); // Pass the data from the controller
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const labels = @json($weeklyChartData['labels']); // This should be ["Monday", "Tuesday", ...]
            const salesData = @json($weeklyChartData['sales']);
            const profitData = @json($weeklyChartData['profit']);
